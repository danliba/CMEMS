...
local_storage_directory_name = 'D:\\descargas\\CMEMS\\CHL'
...
dict_id = {"Temperature_Dailymean_MERCATOR": \
           ["-v thetao","-d global-reanalysis-phy-001-030-daily", \
            "-s GLOBAL_REANALYSIS_PHY_001_030-TDS", "-m https://nrt.cmems-du.eu/motu-web/Motu"], \
            "Temperature_Dailymean_METOFFICE": \
           ["-v thetao", "-d global-reanalysis-phy-001-030-daily ", \
            "-s GLOBAL_REANALYSIS_PHY_001_030-TDS", "-m https://nrt.cmems-du.eu/motu-web/Motu"]
          }
