...
username_cmems = 'landrew'
password_cmems = 'STRAtocaster_12'
...
local_storage_directory_name = 'D:\\descargas\\CMEMS\\salt'
...
dict_id = {"Salinity_Dailymean_MERCATOR": \
           ["-v so","-d global-reanalysis-phy-001-030-daily", \
            "-s GLOBAL_REANALYSIS_PHY_001_030-TDS", "-m http://my.cmems-du.eu/motu-web/Motu"], \
            "Salinity_Dailymean_METOFFICE": \
           ["-v so", "-d global-reanalysis-phy-001-030-daily ", \
            "-s GLOBAL_REANALYSIS_PHY_001_030-TDS", "-m http://my.cmems-du.eu/motu-web/Motu"]
          }
